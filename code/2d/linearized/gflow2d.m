...
J =@(t,x,Flag) jacob(x,DX,DXX,DXXXX,DY,DYY,DYYYY,cleanup,delta,epsilon,n);
options = odeset('Stats','on','Jacobian',J,'RelTol',1e-1,'AbsTol',1e-1);
[t,u] = ode45(@(t,u,Flag) grad2d(t,u,DX,DXX,DXXXX,DY,DYY,DYYYY,cleanup,delta,epsilon,n),t,guess,[],options);
