...
f = functional2d(u,DX,DXX,delta,epsilon)+norm(guess-u)^2;
grad=reshape(-grad2d(0,reshape(u,[n^2,1]),DX,DXX,DXXXX,delta,epsilon,n),[n,n])+2*(u-guess);
end
